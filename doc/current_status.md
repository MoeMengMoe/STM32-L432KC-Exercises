...
| 风扇手动模式 | 🔧 开发中 | 旋转编码器 TIM2_CH1/CH2, PA0/PA1 直控速度 |
...
### 硬件
- **旋转编码器**：TIM2 Encoder，A/CLK 接 PA0(TIM2_CH1)，B/DT 接 PA1(TIM2_CH2)，COM 接 GND
- **注意**：不可使用 PA5 作为编码器输入。本板实测 PA5 电平不随旋钮变化，会导致 TIM2 计数只在相邻值之间抖动。
- **ENC_KEY**：PA6，EXTI 下降沿中断，STATUS_PAGE 下切换 MANUAL↔AUTO

### 模式
- **MANUAL**：旋转编码器累计值 → 风扇速度/方向
