...
STM32L432KC (NUCLEO-L432KC) firmware project. Cortex-M4F @ ~72MHz, 256KB Flash, 48KB+16KB RAM. Uses STM32CubeMX for pin/peripheral configuration and CMake + Ninja for building.
